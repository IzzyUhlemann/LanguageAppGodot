...
func _ready():
	...
	list = load_file_string("res://language/music.txt")
	generate_labels()
...
func generate_labels():
	...
	for i in list.size() - 1:
		...
		newLabel.label_type = newLabel.LabelType.ALPHABET
...
func play_word_audio():
	...
	DisplayServer.tts_speak(list[curWord][0], voice_id, 70, 100.0, 1.0, 10, false)
